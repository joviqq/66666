...
//import com.freepaay.dwz.common.util.ServerInfo;
//import com.freepaay.dwz.framework.config.AppConfiguration;
//import com.freepaay.dwz.framework.config.Constants;
//import com.freepaay.dwz.web.editor.DateEditor;
//import com.freepaay.dwz.web.editor.DoubleEditor;
//import com.freepaay.dwz.web.editor.IntegerEditor;
//import com.freepaay.dwz.web.editor.LongEditor;
...
//	}
	...
	protected ModelAndView ajaxDone(int statusCode, String message, String forwardUrl) {
		String newpath ="";
		newpath =forwardUrl.substring(0, forwardUrl.indexOf("/", 1)+1);
//		ModelAndView mav = new ModelAndView(newpath+"ajaxDone");
		//toDO
	...
	protected ModelAndView ajaxDoneSuccess(String message,String url) {
		return ajaxDone(200, message, url);
	}
	...
	protected ModelAndView ajaxDoneError(String message,String url) {
		return ajaxDone(300, message, url);
	}
